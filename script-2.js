...
{no:'02',title:'灾后废物无害化处理装备',en:'E-WHITEING',type:'System Design · Future Mobility',cover:'works/disaster-cover.png',images:['works/disaster-cover.png','works/disaster-system.png','works/disaster-details.png']},
{no:'03',title:'智能网联轿跑驾驶舱 HMI',en:'Intelligent Coupe Cockpit',type:'HMI · Product Visualization',cover:'works/cockpit-cover.png',images:['works/cockpit-cover.png','works/cockpit-product.png','works/cockpit-hmi.png','works/cockpit-interior.png','works/cockpit-scene.png']},
...
const awards=[
{no:'A01',title:'城市内涝搜救机器人',award:'2025 DIA 中国设计智造大奖 · 佳作奖',cover:'works/robot-award-cover.png',images:['works/dia-robot.png']},
{no:'A02',title:'青少年脊柱姿态监测设计',award:'蓝桥杯设计赛 · 省级三等奖',cover:'works/posture-award-cover.png',images:['works/posture-1.png','works/posture-2.jpg','works/posture-3.png']}];
...
const observer=new IntersectionObserver(entries=>entries.forEach(e=>e.isIntersecting&&e.target.classList.add('isVisible')),{threshold:.1});
